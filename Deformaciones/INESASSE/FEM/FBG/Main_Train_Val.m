...
Folder_Path = 'Data\';
File_Name = 'LSTM_FEM_Data.mat';
load([Folder_Path File_Name])


%Give the correct variable names to the data
Data_Tr = LSTM.Ty_Si_St_Tr;
Labels_Tr = LSTM.Ty_Si_La_Tr;
Data_Val = LSTM.Ty_Si_St_Val;
Labels_Val = LSTM.Ty_Si_La_Val;
Data = LSTM.Ty_Si_St_Te;
Labels = LSTM.Ty_Si_La_Te;
